...
public:
    ...
    // gear lane of zero on 2026-09-05 (Pierre: "1", spend from the purse above the reserve). The
    // reserve passed here is the CURRENT repair bill ("repair cost"), as for food and drink
    // (Pierre, 2026-09-12).
