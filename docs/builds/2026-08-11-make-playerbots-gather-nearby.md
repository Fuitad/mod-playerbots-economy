...
The point specific gathering destination fix is deployed and healthy, but its ten minute 240 bot observation recorded zero authoritative Gathered events. The current deferred loot confirmation fix has not yet been deployed. Production gathering and downstream circulation therefore remain unverified until Criterion 10 passes on the next candidate.
