...
The current point specific gathering destination fix has not yet been deployed. The preceding combined worldserver candidate is deployed and healthy, but its ten minute 240 bot observation recorded zero authoritative Gathered events. Production gathering and downstream circulation therefore remain unverified until Criterion 10 passes on the next candidate.
